...
const requiredSnippets = [
  ...
  [html, "Current Australian work rights under Student visa conditions", "index concise work-right status"],
  ...
  [html, "concurrent voting", "index SecureVote concurrency validation"],
  [html, "fail-closed deployment behaviour", "index SecureVote fail-closed validation"],
...
const staleSnippets = [
  ...
  "Seeking roles starting 1 December 2026 or later",
  "Student visa subclass 500, valid until 15 March 2027",
  "Any future visa pathway remains future intent",
  "1,384 tests",
  "243-test collection",
  "239 pass locally",
